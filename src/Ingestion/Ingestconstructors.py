...
Script Purpose:
    ...
    - Uses the `SINGLE ROW INSERT` command to load data from json File to bronze table.
...
class DataPipeline:
    ...
    def extract_data(self):
        try:
            ...
            self.data = pd.read_json(self.source, dtype=constructors_schema)
            return self.data
    ...
    def load_data(self, data):
        ...
        try:
            ...
            try:
                insert_script = """
                                    INSERT INTO bronze.constructor
                                                (
                                                                constructorID,
                                                                name,
                                                                nationality,
                ...
                delete_script = """exec bronze.delete_constructor"""
                cursor = conn.cursor()
...
source_file_path = r"C:\Users\Game On\python-formula1-de\data\landing\constructors.json"
