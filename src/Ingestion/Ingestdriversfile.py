    ...
    def transform_data(self, data):
        ...
        try:
           # data['date'] = pd.to_datetime(data['date'], format='%Y/%m/%d')
            ...
            print(f"There was {len(data)} rows affected....")
            return self.data
        except Exception as e:
    ...
    def load_data(self, data):
        ...
        try:
            ...
            try:
                ...
                delete_script = """exec bronze.delete_drivers"""
                cursor = conn.cursor()
                cursor.execute(delete_script)
                cursor.executemany(insert_script, rows)
                print(f"There was {len(data)} rows inserted...")  
                conn.commit()
            except Exception as e:
...
source_file_path = r"C:\Users\Game On\python-formula1-de\data\landing\drivers.json"
